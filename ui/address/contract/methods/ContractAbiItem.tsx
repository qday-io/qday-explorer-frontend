import { AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Alert, Box, Text } from "@chakra-ui/react";
          ...
          <Element as="h2" name={"method_id" in data ? getElementName(data.method_id) : ""}>
            ...
            >
              ...
              <Box
                ...
                color={{ base: color.textPrimary, md: color.textSecondary }}
              >
              ...
              {"method_id" in data && (
                <>
                  <Tag paddingX={2} paddingY={1} backgroundColor={color.popupHeader}>
                    <Text as="span" fontSize={12} fontWeight={400} color={color.textSecondary}>
                      {data.method_id}
                    </Text>
                  </Tag>
