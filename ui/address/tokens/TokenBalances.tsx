...
const TokenBalances = () => {
  ...
  const tokensNumText =
    tokensInfo.num > 0 ? `${prefix}${tokensInfo.num} ${tokensInfo.num > 1 ? "tokens" : "token"}` : "0";
  ...
  return (
    <Flex columnGap={3} rowGap={3} mt={{ base: "6px", lg: 0 }} flexDirection={{ base: "column", lg: "row" }}>
      <TokenBalancesItem
        ...
        icon={<IconSvg name="wallet" boxSize="20px" flexShrink={0} color={color.textSecondary} />}
      />
      <TokenBalancesItem
        ...
        isLoading={addressQuery.isPending || tokenQuery.isPending}
        icon={<SvgToken width={24} height={24} />}
      />
      <TokenBalancesItem
        name="Tokens"
        value={tokensNumText}
        ...
        isLoading={addressQuery.isPending || tokenQuery.isPending}
        icon={<IconSvg name="tokens" boxSize="20px" flexShrink={0} color={color.textSecondary} />}
      />
    </Flex>
  );
};
