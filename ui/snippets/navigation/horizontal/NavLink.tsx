...
import type { Variants } from "ui/shared/links/useLinkStyles";
...
const NavLink = ({ className, item, noIcon, ...props }: Props) => {
  ...
  return (
    <chakra.li listStyleType="none">
      ...
      >
        ...
        {isHighlighted && (
          <LightningLabel iconColor={bgColor} position={{ lg: "static" }} ml={{ lg: "2px" }} isCollapsed={false} />
        )}
      </Link>
    </chakra.li>
  );
