import { Box, Flex, Drawer, DrawerOverlay, DrawerContent, DrawerBody, useDisclosure } from "@chakra-ui/react";
  ...
  return (
    <>
      <Box padding={2} onClick={onOpen} cursor="pointer">
        <IconSvg name="burger" boxSize={6} display="block" color={color.textSecondary} aria-label="Menu button" />
      </Box>
