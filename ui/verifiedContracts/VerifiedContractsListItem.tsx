  ...
  return (
    <ListItemMobile rowGap={3}>
      ...
      <Flex columnGap={3}>
        ...
        <Skeleton isLoaded={!isLoading} {...valueStyle}>
          <span>{balance}</span>
        </Skeleton>
      </Flex>
      <Flex columnGap={3}>
      ...
      <Flex columnGap={3}>
        <Skeleton isLoaded={!isLoading} {...labelStyle} flexShrink="0">
          Compiler
        </Skeleton>
        <Skeleton isLoaded={!isLoading} display="flex" flexWrap="wrap" {...valueStyle}>
          <Box textTransform="capitalize" fontWeight={600} color={color.textPrimary}>
            {data.language}
          </Box>
          <Box color="text_secondary" wordBreak="break-all" whiteSpace="pre-wrap">
            {" "}
      ...
      <Flex columnGap={3}>
        ...
        <Flex alignItems="center" columnGap={2}>
          ...
          <TimeAgoWithTooltip timestamp={data.verified_at} isLoading={isLoading} {...valueStyle} />
        </Flex>
      </Flex>
      <Flex columnGap={3}>
        <Skeleton isLoaded={!isLoading} {...labelStyle}>
