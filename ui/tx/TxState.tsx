  ...
  return (
    <>
      {!isError && !txQuery.isError && (
        <Text mb={6} fontSize={{ base: 12, md: 16 }} fontWeight={400} color={color.textSecondary}>
          A set of information that represents the current state is updated when a transaction takes place on the
          network. The below is a summary of those changes.
        </Text>
      )}
      <DataListDisplay
