    ...
    if (hasNovesInterpretation && novesInterpretationQuery.data) {
      ...
      return (
        <Flex mr={{ base: 0, lg: 6 }} flexWrap="wrap" alignItems="center">
          ...
          />
          {hasViewAllInterpretationsLink && <Link href={`#${TX_ACTIONS_BLOCK_ID}`}>View all</Link>}
        </Flex>
      );
  ...
  return (
    <Box display={{ base: "block", lg: "flex" }} alignItems="center" w="100%">
      ...
      >
        ...
        {appActionData && hasAnyInterpretation && <AppActionButton data={appActionData} txHash={hash} source="Txn" />}
