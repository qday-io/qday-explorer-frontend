...
const VerifiedContracts = () => {
  ...
  const [type, setType] = React.useState(
    (getQueryParamString(router.query.filter) as VerifiedContractsFilters["filter"]) || undefined
  );
  ...
  const typeFilter = (
    <VerifiedContractsFilter onChange={handleTypeChange} defaultValue={type} hasActiveFilter={Boolean(type)} />
  );
