    ...
    return [
      config.features.mudFramework.isEnabled &&
        ...
        mudTablesCountQuery.data > 0 && {
          ...
          component: (
            <AddressMud scrollRef={tabsScrollRef} shouldRender={!isTabsLoading} isQueryEnabled={areQueriesEnabled} />
          ),
        },
      {
        id: "txs",
        ...
        component: (
          <AddressTxs scrollRef={tabsScrollRef} shouldRender={!isTabsLoading} isQueryEnabled={areQueriesEnabled} />
        ),
      },
      ...
      addressTabsCountersQuery.data?.logs_count
        ? {
            ...
            component: (
              <AddressLogs scrollRef={tabsScrollRef} shouldRender={!isTabsLoading} isQueryEnabled={areQueriesEnabled} />
            ),
          }
        : undefined,
  ...
  const tags: Array<EntityTag> = React.useMemo(() => {
    return [
      ...
      addressQuery.data?.implementations?.length
        ? { slug: "proxy", name: "Proxy", tagType: "custom" as const, ordinal: -1 }
        : undefined,
