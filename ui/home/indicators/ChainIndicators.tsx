...
const indicators = INDICATORS.filter(({ id }) => config.UI.homepage.charts.includes(id)).sort((a, b) => {
...
const ChainIndicators = ({ style, ...props }: Props) => {
  ...
  return (
    ...
    >
      ...
      {indicators.length > 1 && (
        <Flex flexShrink={0} flexDir="column" as="ul" borderRadius="lg" rowGap="6px" m={{ base: "auto 0", lg: 0 }}>
