...
const LogDecodedInputDataTable = ({ data, isLoading }: Props) => {
  ...
  const gridTemplateColumnsBase = hasIndexed ? "50px 60px 40px minmax(0, 1fr)" : "50px 60px minmax(0, 1fr)";
  const gridTemplateColumnsLg = hasIndexed ? "80px 80px 80px minmax(0, 1fr)" : "80px 80px minmax(0, 1fr)";
